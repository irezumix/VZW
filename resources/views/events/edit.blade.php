...
<form action="{{ route('events.update', $event->id) }}" method="post" class="create-edit-form">
    ...
    <span class="input-euro left">
                    <input type="number" min="0" step="any" id="prijs" name="prijs" class="form-control" value="{{$event->prijs}}"> </span>
                            @if($errors->has('prijs'))
                                    <span class="error">
                                        {{ $errors->first('prijs') }}
                                    </span>
                        ...
                        <input type="date" id="datum" name="datum" placeholder="YYYY-MM-DD" class="form-control" value="{{$event->datum}}">
                                @if($errors->has('datum'))
                                        <span class="error">
                                            {{ $errors->first('datum') }}
                                        </span>
                    ...
                    <div class="col-sm-10">
                    <textarea name="description" id="description" class="form-control" id="" cols="40" rows="4" >{{$event->description}}</textarea>
